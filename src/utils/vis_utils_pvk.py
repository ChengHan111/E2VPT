        ...
        if "Total Parameters: " in line:
            ...
            if dataset_type == 'vtab_rewind' or dataset_type == 'fgvc_rewind':
                ...
                if dataset_type == 'vtab_rewind':
                    ...
                    mask_tokens_pieces_path = root_path + '/output_fgvc_before_pruning/' + f'{data_name}_{P_value}_{VK_value}_SHARED_{Shared}_INIT_{Init}_ACC_0_BS128/{feat_type}/lr{lr}_wd{wd}/run1/mask_tokens_pieces/{cls_token_pieces_mask}_soft_tokens_pieces_to_mask.json'
